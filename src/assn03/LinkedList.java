...
public class LinkedList<T> {
    ...
    public void removeAtIndex(int i) {
        ...
        while(current.getNext() != getNode(i)) {
    ...
    public void removeRepeats() {
        Node<T> current = head;
        while(current != null) {
            while ((current.getNext() != null) && (current.getValue().equals(current.getNext().getValue()))) {
